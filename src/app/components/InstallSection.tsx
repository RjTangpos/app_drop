    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-14">
          ...
          <h2 id="install-title" className="text-display font-bold text-foreground tracking-tight mb-4">
            Install in 3 steps
          </h2>
        ...
        >
          {steps?.map((step, index) => (
            ...
            >
              ...
              {/* Content */}
              <h3 id={`step-${index}-title`} className="text-lg font-semibold text-foreground tracking-tight mb-2">
                {step?.title}
              </h3>
              ...
              {/* Connector arrow (between cards on desktop) - decorative */}
