  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="reveal-hidden mb-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="max-w-xl">
              <p className="text-xs font-bold uppercase tracking-widest text-primary mb-3">Why AppDrop</p>
        ...
        {/* Bento Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-border rounded-3xl overflow-hidden border border-border shadow-sm">
          {features?.map((feature, index) => (
            ...
            >
              ...
              {/* Hover arrow */}
              {!feature?.wide && (
                <div className="absolute bottom-6 right-6 w-8 h-8 rounded-full border border-border flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:border-primary group-hover:text-primary bg-card">
              ...
              {/* Accent decoration for wide card */}
              {feature?.wide && (
                <div className="absolute right-8 bottom-6 top-6 w-24 opacity-5 group-hover:opacity-10 transition-opacity pointer-events-none">
