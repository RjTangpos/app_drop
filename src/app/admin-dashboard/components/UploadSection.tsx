...
export default function UploadSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setForm({ versionName: '', versionCode: '', platform: 'Android', releaseNotes: '', minAndroid: '8.0', status: 'draft' });
    }, 3000);
  };
  ...
  return (
    <div className="max-w-2xl">
      ...
      {success && (
        <div className="mb-6 flex items-center gap-3 px-5 py-4 bg-green-50 border border-green-200 rounded-2xl animate-bounce-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        {/* File Drop Zone */}
        <div
          className={`file-drop-zone rounded-2xl p-8 text-center cursor-pointer transition-all ${dragOver ? 'dropzone-active' : ''} ${selectedFile ? 'border-green-400 bg-green-50' : ''}`}
