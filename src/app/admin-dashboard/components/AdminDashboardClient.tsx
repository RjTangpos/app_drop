      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-card border-b border-border px-4 sm:px-6 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-base font-semibold text-foreground capitalize">{activeTab}</h1>
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6">
          {activeTab === 'overview' && (
            <div className="animate-fade-up opacity-0 space-y-6" style={{ animationFillMode: 'forwards' }}>
              <StatsCards />
