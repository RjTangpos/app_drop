      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-8 gap-y-2">
            <Link href="/" className="flex items-center gap-2" aria-label="AppDrop home">
              <AppLogo size={28} />
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#" className="text-xs text-muted-foreground hover:text-foreground transition-colors" aria-label="Terms of Service">
              Terms
            </a>
          </div>
        </div>
